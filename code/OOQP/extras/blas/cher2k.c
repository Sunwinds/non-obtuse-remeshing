/* cher2k.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int cher2k_(uplo, trans, n, k, alpha, a, lda, b, ldb, beta, 
	c__, ldc, uplo_len, trans_len)
char *uplo, *trans;
integer *n, *k;
complex *alpha, *a;
integer *lda;
...
/*     Quick return if possible. */
    ...
    if (*n == 0 || (alpha->r == (float)0. && alpha->i == (float)0. || *k == 0)
	     && *beta == (float)1.) {
	return 0;
    }
...
/*     And when  alpha.eq.zero. */
	...
	if (upper) {
		...
		for (j = 1; j <= i__1; ++j) {
			...
			i__3 = i__ + j * c_dim1;
			c__[i__3].r = (float)0., c__[i__3].i = (float)0.;
/* L10: */
		    }
/* L20: */
		}
...
/* L30: */
		    ...
		    c__[i__2].r = r__1, c__[i__2].i = (float)0.;
/* L40: */
		}
	    }
	} else {
...
/* L100: */
		...
		for (l = 1; l <= i__2; ++l) {
		    i__3 = j + l * a_dim1;
		    i__4 = j + l * b_dim1;
		    if (a[i__3].r != (float)0. || a[i__3].i != (float)0. || (
			    b[i__4].r != (float)0. || b[i__4].i != (float)0.))
			     {
...
/* L110: */
			...
			c__[i__3].r = r__1, c__[i__3].i = (float)0.;
		    }
/* L120: */
		}
/* L130: */
...
/*                   C. */
	...
	if (upper) {
		...
		i__2 = j;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    temp1.r = (float)0., temp1.i = (float)0.;
		    temp2.r = (float)0., temp2.i = (float)0.;
		    i__3 = *k;
		    for (l = 1; l <= i__3; ++l) {
