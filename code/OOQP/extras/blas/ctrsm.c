/* ctrsm.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int ctrsm_(side, uplo, transa, diag, m, n, alpha, a, lda, b, 
...
/*     And when  alpha.eq.zero. */
	...
	for (j = 1; j <= i__1; ++j) {
		...
		i__3 = i__ + j * b_dim1;
		b[i__3].r = (float)0., b[i__3].i = (float)0.;
/* L10: */
	    }
/* L20: */
	}
...
/*           Form  B := alpha*inv( A )*B. */
		...
		i__1 = *n;
		for (j = 1; j <= i__1; ++j) {
		    if (alpha->r != (float)1. || alpha->i != (float)0.) {
			i__2 = *m;
			for (i__ = 1; i__ <= i__2; ++i__) {
			    i__3 = i__ + j * b_dim1;
			    i__4 = i__ + j * b_dim1;
...
/* L30: */
		    ...
		    for (k = *m; k >= 1; --k) {
			i__2 = k + j * b_dim1;
			if (b[i__2].r != (float)0. || b[i__2].i != (float)0.) 
				{
			    if (nounit) {
				i__2 = k + j * b_dim1;
...
/* L70: */
		    ...
		    for (k = 1; k <= i__2; ++k) {
			i__3 = k + j * b_dim1;
			if (b[i__3].r != (float)0. || b[i__3].i != (float)0.) 
				{
			    if (nounit) {
				i__3 = k + j * b_dim1;
				c_div(&q__1, &b[k + j * b_dim1], &a[k + k * 
...
/* L240: */
		    ...
		    for (k = j + 1; k <= i__1; ++k) {
			i__2 = k + j * a_dim1;
			if (a[i__2].r != (float)0. || a[i__2].i != (float)0.) 
				{
			    i__2 = *m;
			    for (i__ = 1; i__ <= i__2; ++i__) {
				i__3 = i__ + j * b_dim1;
