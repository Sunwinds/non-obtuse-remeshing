...
public:
	...
	// returns the isosurface vertices
	// return value: number of vertices
	int getVertices(double* &verticesList);
	// returns the isosurface triangles
	// return value: number of triangles
	int getTriangles(int** &trianglesList);
	// returns the isosurface normals
	// return value: number of vertices
	int getNormals(double* &normalsList);
	
	// returns m_nCellsX
	unsigned int getNumCellX() const;  
	// returns m_nCellsY
	unsigned int getNumCellY() const;  
	// returns m_nCellsZ
	unsigned int getNumCellZ() const;  
	
	// returns m_fCellLengthX
	float getCellLengthX() const;
	// returns m_fCellLengthY
	float getCellLengthY() const;
	// returns m_fCellLengthZ
	float getCellLengthZ() const;

	// returns m_ptScalarField
	const T* getScalarField() const;
