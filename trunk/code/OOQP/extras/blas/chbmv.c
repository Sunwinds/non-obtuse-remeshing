/* chbmv.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int chbmv_(uplo, n, k, alpha, a, lda, x, incx, beta, y, incy,
	 uplo_len)
char *uplo;
integer *n, *k;
complex *alpha, *a;
...
/*     Quick return if possible. */
    ...
    if (*n == 0 || alpha->r == (float)0. && alpha->i == (float)0. && (beta->r 
	    == (float)1. && beta->i == (float)0.)) {
	return 0;
    }
