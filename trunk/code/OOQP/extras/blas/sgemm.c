/* sgemm.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int sgemm_(transa, transb, m, n, k, alpha, a, lda, b, ldb, 
...
/*     Quick return if possible. */
    ...
    if (*m == 0 || *n == 0 || (*alpha == (float)0. || *k == 0) && *beta == (
	    float)1.) {
	return 0;
    }
