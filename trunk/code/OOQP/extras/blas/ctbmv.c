/* ctbmv.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int ctbmv_(uplo, trans, diag, n, k, a, lda, x, incx, 
...
/* L20: */
		...
		for (j = 1; j <= i__1; ++j) {
		    i__4 = jx;
		    if (x[i__4].r != (float)0. || x[i__4].i != (float)0.) {
			i__4 = jx;
...
/* L40: */
		...
		for (j = *n; j >= 1; --j) {
		    i__1 = j;
		    if (x[i__1].r != (float)0. || x[i__1].i != (float)0.) {
			i__1 = j;
