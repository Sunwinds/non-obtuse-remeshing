/* chpr2.f -- translated by f2c (version 20000704).
...
/* Subroutine */ int chpr2_(uplo, n, alpha, x, incx, y, incy, ap, uplo_len)
char *uplo;
integer *n;
complex *alpha, *x;
integer *incx;
...
/*     Quick return if possible. */
    ...
    if (*n == 0 || alpha->r == (float)0. && alpha->i == (float)0.) {
	return 0;
    }
...
/*        Form  A  when upper triangle is stored in AP. */
	...
	if (*incx == 1 && *incy == 1) {
		...
		i__2 = j;
		i__3 = j;
		if (x[i__2].r != (float)0. || x[i__2].i != (float)0. || (y[
			i__3].r != (float)0. || y[i__3].i != (float)0.)) {
		    r_cnjg(&q__2, &y[j]);
...
/* L10: */
		    ...
		    ap[i__2].r = r__1, ap[i__2].i = (float)0.;
		} else {
		    i__2 = kk + j - 1;
		    i__3 = kk + j - 1;
		    r__1 = ap[i__3].r;
